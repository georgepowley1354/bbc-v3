  ...
  return (
    <html lang="en" className={`${lora.variable} ${raleway.variable}`}>
      <body className="antialiased bg-haven-bg text-haven-text font-body">
        ...
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-50 focus:px-4 focus:py-2 focus:bg-haven-accent-interactive focus:text-haven-text-inverse focus:rounded focus:font-body focus:font-semibold focus:text-sm"
        >
